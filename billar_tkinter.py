#DEterminar la pos de los sensores
#Fuerza de los sensores hacia su ubicación original
#
...
#REtornavalores        
        #vel = Vec()#self.vel + self.f*(1/self.m)*t
        #pos=self.get_pos() + self.vel*t + self.f*(t**2/self.m/2)
        #return pos,vel
...
if __name__ == "__main__":
    ...
    #scene.setImage('img/UD_@8.matrix')
    disc0 = Disc(scene)
    ...
    disc1 = Disc(scene)#,control=control)
#     disc.things['sensors'] = Matrix(7,3,[
#                                     3*disc.r,-1.5*disc.r,1,
#                                     3*disc.r,-1*disc.r,1,
#                                     3*disc.r,-0.5*disc.r,1,
#                                     3*disc.r,0,1,
#                                     3*disc.r,0.5*disc.r,1,
#                                     3*disc.r,1*disc.r,1,
#                                     3*disc.r,1.5*disc.r,1,
