#Este módulo debe permitir visualizar todas las propiedades de la escena y sus componentes


#Formato para conectar puerto serial y verlo
#Una clase de puerto serial
  #meodos read y write o ver los de micropython con buffer, buffers cíclicos
